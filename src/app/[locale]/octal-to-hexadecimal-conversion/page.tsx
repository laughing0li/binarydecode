...
export async function generateMetadata({
    ...
    const href = 'octal-to-hexadecimal-conversion';
    return Meta({ params: { locale }, namespace: 'octal-to-hex', url: href });
};
const OctalToHex = () => {
    const t = useTranslations('octal-to-hex')
    return (
        <Container className="prose prose-a:text-indigo-800 prose-a:no-underline dark:prose-h1:text-zinc-300 dark:prose-h2:text-zinc-300 dark:prose-p:text-zinc-300 dark:prose-a:text-indigo-300 dark:prose-li:text-zinc-300">
            <p>
                ...
                <a href="/what-is-hexadecimal-code">{t('a-1')}</a> {t('description1')}
            </p>
